...
class PgSectionWidget extends StatelessWidget {
  final List<ListingModel> pgList;
  final bool isLoading;
  final List<String> fallbackImages;
  final VoidCallback onViewAll;
  final Function(ListingModel) onListingTap;

  const PgSectionWidget({
    super.key,
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    "Hostel&Pg Not Found in Your Area",
