...
class DanceCentreSectionWidget extends StatelessWidget {
  final List<ListingModel> danceList;
  final bool isLoading;
  final List<String> fallbackImages;
  final VoidCallback onViewAll;
  final Function(ListingModel) onListingTap;

  const DanceCentreSectionWidget({
    super.key,
    required this.danceList,
  ...
  Widget _buildListingList() {
    if (!isLoading && danceList.isEmpty) {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    "Dance Center Not Found in Your Area",
    ...
    return ListView.separated(
      ...
      itemCount: isLoading ? 4 : danceList.length,
      separatorBuilder: (_, __) => sizedBoxWidth(width: 14.w),
      itemBuilder: (context, index) {
        ListingModel listingModel =
            isLoading ? ListingModel() : danceList[index];
